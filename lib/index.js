...
var RT = function () {
  ...
  _createClass(RT, [{
    ...
    key: 'updateTicketProperties',
    value: function updateTicketProperties(ticketId, properties, callback) {
      var updateTicketInfo = function () {
        ...
        request.post({
          url: (0, _urlJoin2.default)(this.uribase, 'ticket', ticketId, 'edit'),
          form: form
        }, function (error, response, body) {
          callback(body);
        });
